...
function FormPreview() {
  ...
  return (
    <div className="flex w-1/3 flex-col gap-10">
      ...
      {/*///////////////////////////////////////////  Forms  ///////////////////////////////////////////////*/}
      {status === "personal" && <ResumePersonalForm />}

      {status === "aboutme" && <ResumeAboutmeForm />}

      {status === "education" && <ResumeEucationForm />}

      {status === "skills" && <ResumeSkillsForm />}
      ...
      {status === "normal" && (
        <>
          ...
          <ResumeSection
            ...
            handleEdit={() => setStatus("education")}
          />
