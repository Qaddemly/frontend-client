...
function Footer() {
  return (
    <footer className="">
      <div className="flex flex-col items-center gap-5 bg-main-dark px-10 py-20 text-center text-gray-100 lg:flex-row lg:gap-36 lg:text-start">
      ...
      <div className="border-t border-t-gray-800 bg-main-dark py-5 text-center text-sm text-gray-500 lg:text-start">
