...
export const dummyData: IResumeInfo = {
  personal: {
    fullName: "Youssef Gad",
  ...
  education: [
    {
      ...
      endDate: "2023-05-20",
      description:
        "Focused on software engineering, AI, and embedded systems. Participated in hackathons and research projects.",
    },
    {
